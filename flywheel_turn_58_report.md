# RAG Flywheel — Turn 58 report
Generated: 2026-05-24T02:53:15.424830+00:00
...
- Routes used      : {'semantic': 63, 'n/a': 19, 'unknown': 1}
- Avg latency      : 2051.5 ms
- Avg tokens       : 316.1

## Convergence metrics
- Grader pass rate    : **4.8%** (4/83)
- Checker pass rate   : **1.2%** (1/83)
- Citation coverage   : 4.8% (4/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **82**
- Tiles with zero citations           : **60**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_58_l2_review.md` (manual review per locked decision)
...
- `hive::hive:maturity_stair` — value=Stair 2 — AI answer: _The 'Hive maturity stair' tile reflects the current shift plan status, specifically the published status of the shift pl_
...
- `project-manager::project-manager:active_projects` — value=4 — AI answer: _The number reflects active projects in the Capex / shutdown / contractor / workorder projects per hive category._
