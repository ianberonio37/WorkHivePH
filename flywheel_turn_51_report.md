# RAG Flywheel — Turn 51 report
Generated: 2026-05-23T22:49:48.444694+00:00
...
- Routes used      : {'semantic': 59, 'n/a': 24}
- Avg latency      : 2519.9 ms
- Avg tokens       : 311.8

## Convergence metrics
- Grader pass rate    : **13.3%** (11/83)
- Checker pass rate   : **3.6%** (3/83)
- Citation coverage   : 13.3% (11/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **80**
- Tiles with zero citations           : **48**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_51_l2_review.md` (manual review per locked decision)
...
- `asset-hub::asset-hub:total_assets` — value=30 — AI answer: _The number reflects the total number of assets with parts low in stock, which is 6 [stats#fleet_5163ddb9]._
...
- `asset-hub::asset-hub:pending_approval` — value=0 — AI answer: _The 'Pending approval' tile shows a non-zero value when there are assets awaiting approval. The canonical source view is_
...
- `asset-hub::asset-hub:pm_count` — value= — AI answer: _the canonical source is listed in def#v_pm_compliance_truth_
...
- `pm-scheduler::pm-scheduler:overdue` — value=0 — AI answer: _The 'Overdue PMs' tile on the pm-scheduler.html page shows a non-zero value when there are preventive maintenance tasks _
...
- `predictive::predictive:healthy_assets` — value=1 — AI answer: _The 'Healthy assets' tile on the predictive.html page reflects the number of assets with approved status and no overdue _
...
- `inventory::inventory:out_of_stock` — value=0 — AI answer: _The 'Out of stock' tile will show a non-zero value when the inventory level is below the reorder point, as defined in th_
...
- `shift-brain::shift-brain:top_risk_this_shift` — value=0 — AI answer: _the canonical source is listed in [def#v_risk_truth]. The 'Top risk this shift' tile shows a non-zero value when the lat_
