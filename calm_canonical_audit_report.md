...
- Gap reads (❌ no wrapper exists yet): **6**
...
| `service_requests` | 1 | `v_service_request_truth` (suggested) |
...
**Canonical** (3): `v_service_provider_truth`, `v_worker_achievements_truth`, `v_worker_truth`
...
**Allowed raw** (6): `alert_dismissals`, `amc_briefings`, `anomaly_signals`, `automation_log`, `hive_audit_log`, `parts_staging_recommendations`

### `analytics.html` — ❌ not compliant

**Gap** (1): `analytics_snapshots`
...
**Canonical** (5): `v_hive_readiness_truth`, `v_marketplace_listings_truth`, `v_marketplace_sellers_truth`, `v_service_credit_ledger_truth`, `v_service_credit_topups_truth`
**Gap** (4): `marketplace_listings`, `service_credit_topups`, `service_requests`, `v_credit_posture`
...
**Canonical** (9): `v_alert_truth`, `v_amc_truth`, `v_hives_truth`, `v_inventory_items_truth`, `v_logbook_truth`, `v_pm_scope_items_truth`, `v_risk_truth`, `v_sensor_truth`, `v_worker_truth`
