# RAG Flywheel — Turn 74 report
Generated: 2026-05-24T12:30:58.435695+00:00

## Walk metrics
- Tiles observed   : **73** (73 real / 0 dry)
- Pages walked     : 14 (achievements=7, alert-hub=8, analytics=5, asset-hub=8, hive=4, inventory=4, marketplace=5, ph-intelligence=4, pm-scheduler=4, predictive=7, project-manager=5, report-sender=4, shift-brain=4, skillmatrix=4)
- Routes used      : {'semantic': 73}
- Avg latency      : 3419.0 ms
- Avg tokens       : 309.4

## Convergence metrics
- Grader pass rate    : **0.0%** (0/73)
- Checker pass rate   : **0.0%** (0/73)
- Citation coverage   : 0.0% (0/73 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **73**
- Tiles with zero citations           : **73**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_74_l2_review.md` (manual review per locked decision)
