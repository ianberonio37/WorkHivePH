...
> Get a print-ready maintenance report that's automatically compiled from your existing data, supporting plant managers, operations heads, and auditors in assessing maintenance performance and compliance.

Source: https://workhiveph.com/learn/print-ready-maintenance-analytics-report/
...
3. Click the Generate Report button to compile the report from your existing data.
4. Review the report, which includes the executive summary, KPI tiles, action plan, and sign-off block.
5. Save the report as a PDF using the Save as PDF button.
...
**Worked example:** For instance, a plant manager reviewing the Analytics Report for Boiler B-1 can quickly identify areas for improvement and track performance over time using the 30d, 90d, 180d, and 365d buttons to view data trends.
...
The report is generated from data logged in your logbook and PM completions.

### Who can access the WorkHive Analytics Report?

The report is typically accessed by plant managers, operations heads, auditors, and reliability engineers.

### Is the WorkHive Analytics Report customizable?

The report is automatically generated based on your plant's data, but you can adjust settings to suit your needs.

### How does the WorkHive Analytics Report support ISO compliance?

The report mirrors the standard maintenance audit format, making it suitable for ISO audits and DOLE compliance reviews.

### Can I use the WorkHive Analytics Report for internal audits?

Yes, the report provides valuable insights into maintenance performance and compliance, making it suitable for internal audits.
...
<!-- md-twin source-sha: f329c232149144eb -->
