...
Three layers: (1) aggregation threshold of 8 plants minimum per sector before any metric is published; (2) outlier suppression of the top and bottom 5 percent of values; (3) no reverse-identification fields (plant name, location, parent company, free-text are stripped before aggregation). Only sector, plant size band, and numeric KPIs flow into the benchmark dataset. Independent annual audit verifies the anonymisation pipeline.

### Do I have to share my data to read the reports?

No. Public quarterly reports are free to read for everyone, opt-in or not. The asymmetry is in what you see: opt-in participants see their own plant's metrics displayed alongside the benchmark; non-participants just see the benchmark. This encourages participation without penalising non-participation.

### What sectors are covered?

Initial: manufacturing (food, electronics, automotive, packaging), power generation (thermal, hydro, geothermal, solar), water and wastewater utilities, petrochemicals and refining, BMS/facilities (commercial buildings, hospitals, malls). Sub-sector breakdowns appear as participation grows past the 8-plant threshold. Sectors below threshold are held until enough plants participate to make the benchmark statistically meaningful.

### How often are reports published?

Quarterly. Each quarter's report covers the previous 3 months of data plus year-over-year and 4-quarter trend comparisons. Opt-in participants get the report 1 month before public release for internal review and benchmarking conversations before the market sees the data.
