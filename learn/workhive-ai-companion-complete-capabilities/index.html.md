...
> The WorkHive AI Companion is a free helper you can talk to in your own language. Meet Hezekiah and Zaniah, see everything the companion can do, and learn how to get the most out of it.

Source: https://workhiveph.com/learn/workhive-ai-companion-complete-capabilities/
...
On [Shift Brain](https://workhiveph.com/shift-brain.html), it prepares your shift plan at the start of each shift: the top risks to watch, the preventive jobs due, work carried forward from the last shift, the parts to pre-stage, and a short briefing. On the Project Manager and Analytics pages, it drafts the wider picture: a weekly action plan, a next-failure forecast, and a parts-stockout outlook. Everything is built strictly from your real data, and it refuses to invent values to fill a gap. You can read more on this in [autonomous shift planning](https://workhiveph.com/learn/autonomous-shift-planning-philippine-plants/).
...
If you remember only three of these, make them: **ask "how's my plant?"** for the big picture, **use your voice** so logging stops being a chore, and **tap thumbs up or down** so the companion gets sharper for your whole team. And when you want the full assistant with your own job history at hand, open [My Work Assistant](https://workhiveph.com/assistant.html).

**One more nudge:** the companion also gets sharper on its own. It quietly turns your hive's logbook entries into a growing map of your real failure history over time, so the more your team logs, the better its answers get. Logging is not just paperwork. It is training your own expert.
...
Hezekiah is the hands-on fix expert: torque values, the lock-out order, lubrication intervals, the right protective gear, and what to check next on the exact machine you are standing at. Zaniah is the planner: she looks across the whole team and the whole week, spots repeating problems, weighs cost, risk and timing, and helps you plan and escalate. You switch between them with one tap. Each one hands over to the other when your question crosses over, so if you ask Hezekiah whether something is becoming a pattern he brings in Zaniah, and if you ask Zaniah what torque to use she brings in Hezekiah. Zaniah is the one new workers start with, because orientation usually comes before torque values.
...
Yes. On the Logbook Speak to Fill surface, describe the situation once in a single sentence and it fills the whole entry: the problem, the likely cause, the action taken, the maintenance type, the status, any parts you mentioned, whether the machine had to be locked off, and even a draft alert for your supervisor. It shows you the draft first and only saves when you tap Save, so nothing reaches your records without your confirmation.

### Which safety rules does the companion follow?

It grounds its safety guidance in Philippine rules: the workplace-safety law RA 11058 and the Philippine Electrical Code, not foreign codes as the governing rule. It walks you through the safe steps (isolate, lock, tag, check for zero energy, use a qualified person, get the permit) and it refuses to suggest an unsafe shortcut. It also refuses to make destructive or bulk changes on its own: those go through your supervisor and are recorded.
...
- Related WorkHive guides:
 [Hezekiah and Zaniah personas](https://workhiveph.com/learn/ai-companion-hezekiah-zaniah-personas/) ·
 [The AI Work Assistant](https://workhiveph.com/learn/ai-work-assistant-maintenance-technicians/) ·
 [Voice to text on the plant floor](https://workhiveph.com/learn/voice-to-text-maintenance-philippine-plant-floor/) ·
 [One machine's full history](https://workhiveph.com/learn/asset-brain-360-one-machine-history-philippine-plant/) ·
 [Autonomous shift planning](https://workhiveph.com/learn/autonomous-shift-planning-philippine-plants/)
- WorkHive platform: [workhiveph.com](https://workhiveph.com/)
