# RAG Flywheel — Turn 12 report
Generated: 2026-05-21T18:59:44.668810+00:00
...
- Avg latency      : 3430.2 ms
- Avg tokens       : 1273.9

## Convergence metrics
- Grader pass rate    : **81.0%** (17/21)
- Checker pass rate   : **71.4%** (15/21)
- Citation coverage   : 81.0% (17/21 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **21**
- Tiles with checker FAIL (need work) : **6**
- Tiles with zero citations           : **4**

## Auto-actions taken
- canonical_sources INSERTed : **16**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_12_l2_review.md` (manual review per locked decision)

## Tiles needing work (checker failed)

- `asset-hub::asset-hub:pending_approval` — value=0 — AI answer: _The definition and data source of the 'Pending approval' KPI is not found in the given chunks [def#v_knowledge_freshness_
- `inventory::inventory:low_stock` — value=3 — AI answer: _The specific maintenance records or logbook rows that contribute to the 'Low stock' count in the inventory.html page are_
...
- `rag_tile:asset-hub:pending_approval` — inferred source: `v_knowledge_freshness_truth`
...
- `rag_tile:inventory:low_stock` — inferred source: `v_logbook_truth`
