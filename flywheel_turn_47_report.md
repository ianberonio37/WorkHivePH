# RAG Flywheel — Turn 47 report
Generated: 2026-05-23T12:26:27.276044+00:00
...
- Routes used      : {'n/a': 10, 'semantic': 73}
- Avg latency      : 1833.8 ms
- Avg tokens       : 315.5

## Convergence metrics
- Grader pass rate    : **1.2%** (1/83)
- Checker pass rate   : **1.2%** (1/83)
- Citation coverage   : 1.2% (1/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **82**
- Tiles with zero citations           : **72**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_47_l2_review.md` (manual review per locked decision)
