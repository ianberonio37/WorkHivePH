...
- **Gateway 0.5** — m: bypass=2 via health_surface_discovery_report.json (measured-partial)
...
- **Gateway 0.5** — m: bypass=18 via structured_log_adoption_report.json (measured-partial)
