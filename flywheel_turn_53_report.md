# RAG Flywheel — Turn 53 report
Generated: 2026-05-23T23:24:50.732373+00:00
...
- Routes used      : {'semantic': 67, 'n/a': 15, 'unknown': 1}
- Avg latency      : 2133.1 ms
- Avg tokens       : 341.6

## Convergence metrics
- Grader pass rate    : **6.0%** (5/83)
- Checker pass rate   : **2.4%** (2/83)
- Citation coverage   : 6.0% (5/83 tiles had ≥1 citation)
...
- L2 review queue            : `.tmp/flywheel_turn_53_l2_review.md` (manual review per locked decision)
...
- `asset-hub::asset-hub:total_assets` — value=30 — AI answer: _The 'Total assets' tile on the asset-hub.html page reflects the number of approved assets in the system, which is 30. Th_
...
- `inventory::inventory:out_of_stock` — value=0 — AI answer: _The 'Out of stock' tile will show a non-zero value when the is_out_of_stock flag is true in v_inventory_items_truth. Thi_
...
- `project-manager::project-manager:active_projects` — value=4 — AI answer: _The number reflects the count of active projects in the Capex / shutdown / contractor / workorder projects per hive._
