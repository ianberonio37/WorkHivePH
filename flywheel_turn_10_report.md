# RAG Flywheel — Turn 10 report
Generated: 2026-05-21T11:55:58.417106+00:00
...
- Avg latency      : 3864.7 ms
- Avg tokens       : 1228.0

## Convergence metrics
- Grader pass rate    : **71.4%** (15/21)
- Checker pass rate   : **61.9%** (13/21)
- Citation coverage   : 71.4% (15/21 tiles had ≥1 citation)
...
## Auto-actions taken
- canonical_sources INSERTed : **15**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_10_l2_review.md` (manual review per locked decision)
...
- `asset-hub::asset-hub:critical_assets` — value=6 — AI answer: _The definition of 'Critical assets' is not found in the provided chunks. The v_asset_truth view is defined as a canonica_
...
- `skillmatrix::skillmatrix:total_badges` — value=19 — AI answer: _The calculation of badge_count in v_worker_skill_truth from skill_badges table is not explicitly stated in the provided _
...
- `rag_tile:hive:open_issues` — inferred source: `v_worker_assignment_truth`
