# RAG Flywheel — Turn 59 report
Generated: 2026-05-24T03:10:55.687754+00:00
...
- Routes used      : {'n/a': 15, 'semantic': 68}
- Avg latency      : 2512.4 ms
- Avg tokens       : 395.4

## Convergence metrics
- Grader pass rate    : **9.6%** (8/83)
- Checker pass rate   : **3.6%** (3/83)
- Citation coverage   : 9.6% (8/83 tiles had ≥1 citation)
...
- L2 review queue            : `.tmp/flywheel_turn_59_l2_review.md` (manual review per locked decision)
...
- `asset-hub::asset-hub:pending_approval` — value=0 — AI answer: _The 'Pending approval' tile shows a non-zero value when there are assets with 'pending approval' status. The canonical s_
...
- `skillmatrix::skillmatrix:on_target` — value=5/5 — AI answer: _The number reflects workers who have met or exceeded their skill-count target, sourced from v_worker_skill_truth view [d_
...
- `ph-intelligence::ph-intelligence:plants_in_network` — value=3 — AI answer: _The number reflects the count of distinct hives contributing anonymized benchmark data to the cross-network report [def#_
