# RAG Flywheel — Turn 54 report
Generated: 2026-05-23T23:40:26.109706+00:00
...
- Avg latency      : 2463.1 ms
- Avg tokens       : 339.6

## Convergence metrics
- Grader pass rate    : **7.2%** (6/83)
- Checker pass rate   : **2.4%** (2/83)
- Citation coverage   : 7.2% (6/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **81**
- Tiles with zero citations           : **60**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_54_l2_review.md` (manual review per locked decision)
...
- `inventory::inventory:out_of_stock` — value=0 — AI answer: _This KPI shows a non-zero value when the inventory level falls below the reorder point. The canonical source view is v_i_
...
- `achievements::achievements:xp_this_week` — value=+600 — AI answer: _The 'XP this week' tile on the achievements.html page reflects total community XP earned by the worker in the past 7 day_
...
- `report-sender::report-sender:reports_selected` — value=0 — AI answer: _The 'Reports selected' tile on the report-sender.html page shows a non-zero value when the user has ticked reports to in_
