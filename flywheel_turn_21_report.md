# RAG Flywheel — Turn 21 report
Generated: 2026-05-21T20:00:15.695332+00:00
...
- Avg latency      : 8453.1 ms
- Avg tokens       : 1020.8

## Convergence metrics
- Grader pass rate    : **61.9%** (13/21)
- Checker pass rate   : **61.9%** (13/21)
- Citation coverage   : 57.1% (12/21 tiles had ≥1 citation)
...
## Auto-actions taken
- canonical_sources INSERTed : **10**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_21_l2_review.md` (manual review per locked decision)
...
- `rag_tile:asset-hub:pending_approval` — inferred source: `v_kpi_truth`
