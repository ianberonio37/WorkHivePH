...
(function () {
  ...
  function detectPageContext() {
    ...
    if (path.includes('asset-hub'))         return { page: 'asset-hub',      label: 'Asset Hub',              hint: 'Ask me about any asset in your hive — its history, MTBF, parent equipment, sister machines, parts that fit, or upcoming PMs. The hub is the unified 360 view across logbook, PM, inventory, predictive, and PH benchmarks.' };
