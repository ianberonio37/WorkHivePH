...
(function () {
  ...
  function detectPageContext() {
    ...
    if (path.includes('marketplace-admin'))  return { page: 'marketplace-admin',  label: 'Marketplace Admin',       hint: 'Approve or reject pending listings, verify seller KYB, manage disputes. Ask me about approval criteria, KYB verification steps, or how escrow release works.' };
    if (path.includes('marketplace-seller')) return { page: 'marketplace-seller', label: 'Seller Dashboard',         hint: 'Manage your listings, reply to buyer inquiries, track orders and earnings, and connect your Stripe account to receive payouts.' };
