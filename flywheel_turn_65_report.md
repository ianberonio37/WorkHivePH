# RAG Flywheel — Turn 65 report
Generated: 2026-05-24T07:15:07.208946+00:00
...
- Routes used      : {'semantic': 70, 'n/a': 12, 'simple_recency': 1}
- Avg latency      : 2148.4 ms
- Avg tokens       : 397.0
...
- L2 review queue            : `.tmp/flywheel_turn_65_l2_review.md` (manual review per locked decision)
...
- `pm-scheduler::pm-scheduler:overdue` — value=0 — AI answer: _The 'Overdue PMs' tile on pm-scheduler.html shows a non-zero value when there are preventive maintenance tasks past thei_
...
- `shift-brain::shift-brain:top_risk_this_shift` — value=0 — AI answer: _The 'Top risk this shift' tile shows a non-zero value when a risk score is calculated for an asset within the current sh_
