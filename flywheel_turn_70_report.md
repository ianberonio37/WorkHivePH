# RAG Flywheel — Turn 70 report
Generated: 2026-05-24T10:45:35.792145+00:00
...
- Avg latency      : 3124.0 ms
- Avg tokens       : 349.8

## Convergence metrics
- Grader pass rate    : **16.9%** (14/83)
- Checker pass rate   : **10.8%** (9/83)
- Citation coverage   : 16.9% (14/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **74**
- Tiles with zero citations           : **36**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_70_l2_review.md` (manual review per locked decision)
...
- `alert-hub::alert-hub:amc_daily_brief` — value=None today — AI answer: _The 'AMC daily brief' tile on the alert-hub.html page shows a non-zero value when there are top assets, PMs due, parts t_
...
- `asset-hub::asset-hub:pending_approval` — value=0 — AI answer: _The 'Pending approval' tile shows a non-zero value when there are assets awaiting approval. It reads from v_asset_truth._
...
- `asset-hub::asset-hub:logbook_count` — value= — AI answer: _the canonical source view for the Asset logbook entries KPI is v_logbook_truth_
...
- `predictive::predictive:healthy_assets` — value=1 — AI answer: _The 'Healthy assets' tile on the predictive.html page reflects the number of assets with no parts out of stock and no PM_
...
- `dayplanner::dayplanner:week_count` — value=6 — AI answer: _The 'Tasks this week' tile on the dayplanner.html page counts schedule_items due in the next 7 days for the current work_
