...
source_sha: b0baa91788828bca
last_verified: 2026-07-13
supersedes: null
---
## doc · PRODUCTION_DEPLOY_RUNBOOK

**Owner: Ian (all outward steps are Ian-gated).** Claude prepared + pre-flighted; the push commands are yours to run from YOUR environment. **No deploy credentials are configured locally, so Claude ca
