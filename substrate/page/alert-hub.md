...
source_sha: c66d16448b5e2f97
last_verified: 2026-07-13
supersedes: null
---
## page · `alert-hub.html` — Alert Hub | WorkHive

Size: 114KB · 30 top-level fns. (Retrieve THIS instead of reading the file.)
...
**Functions**: _activeKind, _scheduleAnomalyReload, acknowledgeAlert, actOnAmcBrief, dismissAlert, fetchAmcBriefings, fmtRelative, fmtTime, hideCta, loadAll, loadAnomalyEngine, loadUnifiedAmcBrief, renderAlertSummary, renderAmcCard, renderAnomalyEngine, renderFeed, renderFilters, setCard, setCta, setStat, setTxt, showAmcMsg, showToast, startAmcRealtime, startAnomalyRealtime, startRefresh, stopRefresh, todayPhtIso, wireAmcCardOnce, writeAuditLog
