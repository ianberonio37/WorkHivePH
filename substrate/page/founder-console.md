...
source_sha: 7c6179427c8d653f
last_verified: 2026-07-13
supersedes: null
---
## page · `founder-console.html` — WorkHive Founder Console

Size: 162KB · 53 top-level fns. (Retrieve THIS instead of reading the file.)
...
**RPC calls**: (none)
**Edge invokes**: (none)
**Truth views read**: `v_hive_readiness_truth`, `v_marketplace_listings_truth`, `v_marketplace_orders_truth`, `v_marketplace_sellers_truth`, `v_service_credit_ledger_truth`, `v_service_credit_topups_truth`
