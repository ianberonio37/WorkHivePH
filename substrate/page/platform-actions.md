...
source_sha: 9ca3933012136359
last_verified: 2026-07-13
supersedes: null
---
## page · `platform-actions.html` — Platform Actions · WorkHive

Size: 91KB · 31 top-level fns. (Retrieve THIS instead of reading the file.)
...
**Functions**: _amtOrGap, _btnRestore, _modPrice, _queueErr, _restore, add, applyFeedbackView, closeFeedbackDrawer, emptyText, fbTimeAgo, fetchCreditPosition, fetchFeedback, fetchGcashLeftovers, fetchMktModeration, fetchSvcTopups, openFeedbackDrawer, refreshQueues, refusalMessage, renderCreditPosition, renderFeedback, renderGcashLeftovers, renderMktModeration, renderSvcTopups, saveFeedbackDrawer, setCount, showToast, subscribeFeedbackRealtime, wireFeedback, wireMktModeration, wireSvcTopups, writeAuditLog
