...
Columns (*=NOT NULL): id*, hive_id, machine*, category, rule_id*, alert_title*, alert_detail, evidence, days_to_failure, severity, status, acknowledged_by, acknowledged_at, detected_at, expires_at, detail_source*
