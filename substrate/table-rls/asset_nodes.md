...
Columns (*=NOT NULL): id*, hive_id, auth_uid, worker_name, parent_id, level*, tag*, name*, iso_class, criticality*, location, manufacturer, model, serial_no, install_date, external_ids*, legacy_asset_id, pm_asset_id, status*, submitted_by, approved_by, approved_at, created_at*, updated_at*, lifecycle*, ideal_cycle_time_seconds
