...
ResultValue
Recommended diameter32 mm
Peak flow76.1 L/min
Velocity1.58 m/s
Computed live by WorkHive's calculation engine; standard: Philippine Plumbing Code Table A-2/A-3.
How to use this calculator
Enter the figures for the duty you are sizing: the worked example below uses a flush-valve supply serving 10 WCs and 8 lavatories over 40 m.
The calculator returns Recommended diameter, Peak flow, Velocity, computed per Philippine Plumbing Code Table A-2/A-3.
