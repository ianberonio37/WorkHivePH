...
PROBLEM_PAGES = [
    {
        ...
        "sections": [
            ...
            {"id": "step-1-measure", "h2": "Step 1 &mdash; measure downtime by cause",
            ...
            {"id": "step-2-root-cause", "h2": "Step 2 &mdash; fix the recurring few at root cause",
            ...
            {"id": "step-3-pm-compliance", "h2": "Step 3 &mdash; hold PM compliance above 90%",
             "html": "<p>PM compliance is the leading indicator &mdash; it moves before MTBF does. The SMRP benchmark is at least <strong>90%</strong> of preventive tasks completed on or before their due date. Below that, the schedule is decorative.</p>"
            ...
            {"id": "step-4-condition-monitoring", "h2": "Step 4 &mdash; monitor the critical assets only",
