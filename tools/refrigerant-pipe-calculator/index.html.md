...
How it works
Computed per ASHRAE 2022 Refrig. Hbk Ch.1 | ASTM B280 | ASHRAE 90.1 | PSME.
Worked example (HVAC & Cooling)
Inputs: a 30 kW R410A air-conditioning circuit (7 / 45 °C).
ResultValue
Suction line OD34.93 mm
Liquid line OD15.88 mm
Discharge line OD15.88 mm
Computed live by WorkHive's calculation engine; standard: ASHRAE 2022 Refrig. Hbk Ch.1 | ASTM B280 | ASHRAE 90.1 | PSME.
How to use this calculator
Enter the figures for the duty you are sizing: the worked example below uses a 30 kW R410A air-conditioning circuit (7 / 45 °C).
The calculator returns Suction line OD, Liquid line OD, Discharge line OD, computed per ASHRAE 2022 Refrigeration Handbook | ASTM B280.
...
How is it calculated?The result is computed following ASHRAE 2022 Refrigeration Handbook | ASTM B280. The worked example on this page shows a real computation with real numbers.
...
[Open the interactive Refrigerant Pipe Sizing Calculator in WorkHive (free sign-in)](https://workhiveph.com/engineering-design.html): free with a WorkHive account. Sign-up takes about 30 seconds.
Related calculators
...
<!-- md-twin source-sha: 0e9486d1fcb4feb7 -->
