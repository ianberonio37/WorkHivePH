...
> The Power Factor Correction Calculator sizes the capacitor bank (kVAR) needed to raise power factor from its present value to a target. Free online, with a worked example. Built for Philippine plants by WorkHive.

Source: https://workhiveph.com/tools/power-factor-correction-calculator/
