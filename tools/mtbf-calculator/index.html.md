...
Enter the figures for the duty you are sizing — the worked example below uses a pump that ran 4,000 hours, failed 5 times, and took 40 hours of repair in total.
The calculator returns MTBF, MTTR, Availability, Failures, computed per ISO 14224 | IEC 60050-192 | SMRP.
...
<!-- md-twin source-sha: 5ff9741aaba72a76 -->
