...
ResultValue
Recommended capacity100.1 TR
Capacity352 kW
Efficiency0.64 kW/TR
Computed live by WorkHive's calculation engine; standard: ASHRAE 90.1-2019 Table 6.8.1 | AHRI 550/590 | ASHRAE 2021 Ch.2.
How to use this calculator
Enter the figures for the duty you are sizing — the worked example below uses a 300 kW cooling load on a water-cooled chiller (COP 5.5).
The calculator returns Recommended capacity, Capacity, Efficiency, computed per ASHRAE 90.1-2019 | AHRI 550/590.
...
<!-- md-twin source-sha: a3706bb63839957b -->
