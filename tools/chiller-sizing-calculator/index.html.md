...
> The Chiller Sizing Calculator picks the chiller capacity (TR/kW) and efficiency for a cooling load with a design margin. Free online, with a worked example. Built for Philippine plants by WorkHive.

Source: https://workhiveph.com/tools/chiller-sizing-calculator/
...
| Result | Value |
| --- | --- |
| Recommended capacity | 100.1 TR |
| Capacity | 352 kW |
| Efficiency | 0.64 kW/TR |

Computed live by WorkHive's calculation engine; standard: ASHRAE 90.1-2019 Table 6.8.1 | AHRI 550/590 | ASHRAE 2021 Ch.2.

## How to use this calculator

1. Enter the figures for the duty you are sizing — the worked example below uses a 300 kW cooling load on a water-cooled chiller (COP 5.5).
2. The calculator returns Recommended capacity, Capacity, Efficiency, computed per ASHRAE 90.1-2019 | AHRI 550/590.
...
### What is a chiller sizing calculator TR?

The Chiller Sizing Calculator is a free online tool that computes picks the chiller capacity (TR/kW) and efficiency for a cooling load with a design margin. It shows the formula and a fully worked example so you can check the method, not just the number.

### How is it calculated?

The result is computed from your inputs following ASHRAE 90.1-2019 | AHRI 550/590. The worked example on this page shows a real computation with real numbers.
...
<!-- md-twin source-sha: 5555083a4ae16606 -->
