# RAG Flywheel — Turn 46 report
Generated: 2026-05-23T12:12:05.776867+00:00
...
- Routes used      : {'semantic': 75, 'n/a': 8}
- Avg latency      : 2043.1 ms
- Avg tokens       : 314.8
...
- Tiles with zero citations           : **73**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_46_l2_review.md` (manual review per locked decision)

## Tiles needing work (checker failed)

- `analytics::analytics:mtbf` — value=— — AI answer: _the Worst MTBF (partial) KPI on the analytics.html page measures Mean Time Between Failures (ISO 14224:2016 sec 9.3) per_
