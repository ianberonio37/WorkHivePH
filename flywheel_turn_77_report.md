# RAG Flywheel — Turn 77 report
Generated: 2026-05-24T13:23:08.528146+00:00
...
- Routes used      : {'semantic': 83}
- Avg latency      : 2098.9 ms
- Avg tokens       : 312.0
...
- Tiles with zero citations           : **83**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_77_l2_review.md` (manual review per locked decision)
...
- `achievements::achievements:xp_this_week` — value=+710 — AI answer: _I don't have enough recent records to answer that. Try rephrasing or asking about a specific asset / date._
...
- `marketplace::marketplace:listings_in_view` — value=0 — AI answer: _I don't have enough recent records to answer that. Try rephrasing or asking about a specific asset / date._
