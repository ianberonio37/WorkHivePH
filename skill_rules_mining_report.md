...
| `migration_grant_when_rls_enabled` | security | 88% (66/75) | migrations | convention |
...
| `migration_function_sets_search_path` | security | 100% (200/200) | migrations | convention |
...
| `kg_migrations_no_broadcast_across_hives` | architect | 100% (516/516) | migrations | anti_pattern |
