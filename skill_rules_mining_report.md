...
### `security_no_eval_user_input` (critical)  -- security :: Security Checklist
- **Rule:** No eval() with user-supplied strings in frontend code
- **Conformance:** 98%  (83 / 84)
- **Violators (1):** browser-floor.js
- **Why it matters:** Any eval() with user input is an immediate code-injection vector.
...
- **Conformance:** 98%  (61 / 62)
- **Violators (1):** vehicle-doc-extract
...
|---|---|---|---:|---|
| `migration_function_sets_search_path` | security | medium | 99% | 20260805000051_an_anonymous_visitor_could_run_the_nightly_sweep.sql, 20260806000058_anchor_the_reaction_xp_award_ledger.sql |
| `security_no_eval_user_input` | security | critical | 98% | browser-floor.js |
| `edge_fn_handles_options_preflight` | security | high | 98% | vehicle-doc-extract |
...
| `qa_no_innerhtml_plus_equals` | qa-tester | medium | 95% | design-system.html, report-sender.html |
...
| `frontend_currency_uses_shared_formatter` | frontend | medium | 85% | platform-actions.html |
...
| `designer_dialog_has_aria_modal_true` | designer | medium | 81% | audit-log.html, integrations.html |

## All rules (full conformance ranking)

| Rule | Skill | Conformance | Scope | Polarity |
|---|---|---:|---|---|
| `designer_btn_primary_canonical_gradient` | designer | 0% (0/16) | html_and_js | convention |
...
| `designer_dialog_has_aria_modal_true` | designer | 81% (9/11) | html_pages | convention |
...
| `migration_grant_when_rls_enabled` | security | 83% (67/80) | migrations | convention |
| `frontend_currency_uses_shared_formatter` | frontend | 85% (6/7) | html_pages | convention |
...
| `qa_no_innerhtml_plus_equals` | qa-tester | 95% (40/42) | html_pages | anti_pattern |
| `frontend_no_em_dash_in_prompt_template` | frontend | 95% (59/62) | edge_fns | anti_pattern |
...
| `edge_fn_handles_options_preflight` | security | 98% (61/62) | edge_fns | convention |
| `security_no_eval_user_input` | security | 98% (83/84) | html_and_js | anti_pattern |
| `migration_function_sets_search_path` | security | 99% (239/241) | migrations | convention |
...
| `security_no_service_role_key_frontend` | security | 100% (84/84) | html_and_js | anti_pattern |
| `security_no_stripe_secret_in_frontend` | security | 100% (84/84) | html_and_js | anti_pattern |
| `security_no_static_cors_origin_edge_fn` | security | 100% (62/62) | edge_fns | anti_pattern |
...
| `designer_no_off_brand_orange_e8920a` | designer | 100% (84/84) | html_and_js | anti_pattern |
...
| `qa_no_alert_call` | qa-tester | 100% (84/84) | html_and_js | anti_pattern |
| `frontend_writeAuditLog_called` | frontend | 100% (3/3) | html_pages | convention |
| `edge_fn_uses_get_cors_headers` | security | 100% (62/62) | edge_fns | convention |
| `data_engineer_restore_identity_from_session` | data-engineer | 100% (4/4) | html_pages | convention |
| `security_no_function_constructor` | security | 100% (84/84) | html_and_js | anti_pattern |
| `security_no_token_in_localstorage` | security | 100% (84/84) | html_and_js | anti_pattern |
...
| `kg_migrations_no_broadcast_across_hives` | architect | 100% (593/593) | migrations | anti_pattern |
...
| `frontend_kpi_page_no_local_truth_math` | frontend | 100% (27/27) | html_pages | anti_pattern |
