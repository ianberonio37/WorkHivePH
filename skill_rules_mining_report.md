...
| `migration_function_sets_search_path` | security | 100% (175/175) | migrations | convention |
...
| `kg_migrations_no_broadcast_across_hives` | architect | 100% (483/483) | migrations | anti_pattern |
