# RAG Flywheel — Turn 43 report
Generated: 2026-05-23T11:27:34.091359+00:00
...
- Routes used      : {'semantic': 76, 'n/a': 6, 'simple_recency': 1}
- Avg latency      : 1978.0 ms
- Avg tokens       : 350.1
...
- Tiles with zero citations           : **74**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_43_l2_review.md` (manual review per locked decision)
...
- `alert-hub::alert-hub:high_severity_alerts` — value=37 — AI answer: _The number 37 reflects the count of assets with high or critical composite risk scores, sourced from v_risk_truth. [def#_
