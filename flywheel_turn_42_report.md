# RAG Flywheel — Turn 42 report
Generated: 2026-05-23T11:10:09.817054+00:00
...
- Routes used      : {'semantic': 73, 'n/a': 10}
- Avg latency      : 2067.0 ms
- Avg tokens       : 341.2

## Convergence metrics
- Grader pass rate    : **3.6%** (3/83)
- Checker pass rate   : **1.2%** (1/83)
- Citation coverage   : 3.6% (3/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **82**
- Tiles with zero citations           : **70**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_42_l2_review.md` (manual review per locked decision)

## Tiles needing work (checker failed)

- `analytics::analytics:mtbf` — value=— — AI answer: _The 'Worst MTBF (partial)' KPI on the analytics.html page measures Mean Time Between Failures (ISO 14224:2016 sec 9.3) [_
...
- `pm-scheduler::pm-scheduler:overdue` — value=0 — AI answer: _The 'Overdue PMs' tile on the pm-scheduler.html page will show a non-zero value when there are preventive maintenance ta_
