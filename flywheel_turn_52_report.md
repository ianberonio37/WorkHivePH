# RAG Flywheel — Turn 52 report
Generated: 2026-05-23T23:08:09.913862+00:00

## Walk metrics
- Tiles observed   : **79** (79 real / 0 dry)
- Pages walked     : 15 (achievements=7, alert-hub=8, analytics=5, asset-hub=8, dayplanner=4, hive=4, integrations=6, marketplace=5, ph-intelligence=4, pm-scheduler=4, predictive=7, project-manager=5, report-sender=4, shift-brain=4, skillmatrix=4)
- Routes used      : {'semantic': 60, 'n/a': 19}
- Avg latency      : 2696.4 ms
- Avg tokens       : 364.2

## Convergence metrics
- Grader pass rate    : **8.9%** (7/79)
- Checker pass rate   : **3.8%** (3/79)
- Citation coverage   : 8.9% (7/79 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **76**
- Tiles with zero citations           : **53**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_52_l2_review.md` (manual review per locked decision)

## Tiles needing work (checker failed)

- `analytics::analytics:oee` — value=— — AI answer: _The OEE (avg, partial) KPI on the analytics.html page measures Overall Equipment Effectiveness [def#v_kpi_truth]. The ca_
- `analytics::analytics:mtbf` — value=— — AI answer: _the canonical source is listed in def#v_kpi_truth_
...
- `pm-scheduler::pm-scheduler:due_soon` — value=18 — AI answer: __
...
- `skillmatrix::skillmatrix:detail_panel` — value=4 rows — AI answer: _The skillmatrix tile counts workers who have met or exceeded their skill-count target, reflecting workers on target [def_
- `hive::hive:maturity_stair` — value=Stair 2 — AI answer: _the canonical source is listed in def#shift_plans_
