...
// Doubles as small TEXT color (badges/target rows) on dark tints — every value
// must clear WCAG AA 4.5:1 there. #A78BFA measured 4.12 and #29B6D9 3.8–4.4 as
// text (2026-07-16); the -light variants keep the hue and pass.
const DISCIPLINE_COLORS = {
  'Mechanical':            '#FDB94A',
  'Electrical':            '#FFD700',
  'Instrumentation':       '#5FCCE8',
  'Facilities Management': '#C4B5FD',
