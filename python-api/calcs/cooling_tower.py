...
def calculate(inputs: dict) -> dict:
    ...
    return {
        ...
        "q_w_lps":           round(flow_lps, 2),
        "q_w_m3hr":          round(flow_m3hr, 2),
        "q_w_GPM":           round(flow_gpm, 1),
        ...
        "fan_flow_CMH":      round(air_vol_m3s * 3600, 0),
        "fan_flow_CMH_cell": round(air_vol_m3s * 3600, 0),
