# RAG Flywheel — Turn 62 report
Generated: 2026-05-24T05:41:01.581635+00:00
...
- Routes used      : {'n/a': 17, 'semantic': 60, 'unknown': 1}
- Avg latency      : 2070.8 ms
- Avg tokens       : 356.0

## Convergence metrics
- Grader pass rate    : **6.4%** (5/78)
- Checker pass rate   : **2.6%** (2/78)
- Citation coverage   : 6.4% (5/78 tiles had ≥1 citation)
...
- L2 review queue            : `.tmp/flywheel_turn_62_l2_review.md` (manual review per locked decision)
...
- `hive::hive:open_issues` — value=21 — AI answer: _The 'Open issues' tile on the hive.html page reflects the number of maintenance records with 'Closed' status that are ov_
...
- `ph-intelligence::ph-intelligence:plants_in_network` — value=3 — AI answer: _The number reflects the count of hives contributing anonymized data to the cross-network benchmarks [def#v_ph_intelligen_
...
- `shift-brain::shift-brain:top_risk_this_shift` — value=0 — AI answer: _the canonical source view is v_risk_truth [def#v_risk_truth]. This tile shows a non-zero value when an asset has a risk _
