# RAG Flywheel — Turn 40 report
Generated: 2026-05-23T10:32:43.089854+00:00
...
- Avg latency      : 3047.7 ms
- Avg tokens       : 346.0

## Convergence metrics
- Grader pass rate    : **12.0%** (10/83)
- Checker pass rate   : **4.8%** (4/83)
- Citation coverage   : 12.0% (10/83 tiles had ≥1 citation)

## Gaps found
- Tiles missing canonical anchor      : **0**
- Tiles with checker FAIL (need work) : **79**
- Tiles with zero citations           : **56**

## Auto-actions taken
- canonical_sources INSERTed : **0**
- New L0 tile locks added    : **0**
- L2 review queue            : `.tmp/flywheel_turn_40_l2_review.md` (manual review per locked decision)
...
- `alert-hub::alert-hub:amc_assets` — value= — AI answer: _The AMC assets checked KPI on the alert-hub.html page measures AMC asset counts [def#v_amc_truth]. The canonical source _
...
- `alert-hub::alert-hub:amc_crew` — value= — AI answer: _The AMC crew alerts KPI measures the latest-per-shift AMC briefing, which closes 2 gap reads (ops-home Today ranker + al_
...
- `asset-hub::asset-hub:rcm_edges` — value= — AI answer: _The canonical source view is v_rcm_truth [def#v_rcm_truth]._
- `pm-scheduler::pm-scheduler:overdue` — value=0 — AI answer: _The 'Overdue PMs' tile on pm-scheduler.html will show a non-zero value when there are preventive maintenance tasks past _
...
- `shift-brain::shift-brain:top_risk_this_shift` — value=0 — AI answer: _I don't have enough recent records to answer that. Try rephrasing or asking about a specific asset / date._
