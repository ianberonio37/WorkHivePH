...
- **Trustworthy provenance shown (zero-wrong):** 64 across 21 pages
- **E3 residual (resolved but not yet trustworthy):** 1 — the B.2 hardening backlog
...
### Data value — needs formula-grade element-id→query bind — 1
